...
function CheckoutContent() {
  ...
  const totalPrice = billing === 'yearly' ? parseInt(pricePerMonth) * 12 : parseInt(pricePerMonth);
            ...
            <div className="glass" style={{ padding: '3rem', borderRadius: '30px' }}>
              ...
              {step === 3 && (
                <div className="fade-in" style={{ textAlign: 'center' }}>
                  ...
                  <button className="btn-primary" style={{ width: '100%', padding: '1.2rem' }} onClick={() => alert('Order Placed! Redirecting to Dashboard...')}>
